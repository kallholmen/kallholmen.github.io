...
(function($) {
    ...
    $.fn.bjqs = function(o) {
        ...
        var init = function() {
            ...
            if( state.slidecount > 1 ){
                ...
                */
                ...
                console.log('stop automatic, only one slide');
            }
        ...
        var conf_slide = function() {
            ...
            $canvas = $('<div class="slide-wrapper"></div>');
        ...
        var conf_controls = function() {
            ...
            $c_wrapper  = $('<ul class="controls"></ul>');
            $c_fwd      = $('<li class="next"><a href="#" data-direction="'+ vars.fwd +'">' + settings.nexttext + '</a></li>');
            $c_prev     = $('<li class="prev"><a href="#" data-direction="'+ vars.prev +'">' + settings.prevtext + '</a></li>');
        ...
        var conf_markers = function() {
            ...
            $.each($slides, function(key, slide){
                ...
                var marker = $('<li><a href="#">'+ '<i class="icon-circle"></i>' + '</a></li>');
